...
export const checkIfObjectsAreColliding = (objectOne: CollidableObject, objectTwo: CollidableObject, collisionType: Collision = 'edge') => {
  ...
  switch (collisionType) {
    ...
    case 'center':
      ...
      break;
    case 'overlap':
      const isOverlappingX = (objectOne.hitbox.left >= objectTwo.hitbox.left && objectOne.hitbox.left <= objectTwo.hitbox.right) || (objectOne.hitbox.right >= objectTwo.hitbox.left && objectOne.hitbox.right <= objectTwo.hitbox.right);
      const isOverlappingY = (objectOne.hitbox.top >= objectTwo.hitbox.top && objectOne.hitbox.top <= objectTwo.hitbox.bottom) || (objectOne.hitbox.bottom >= objectTwo.hitbox.top && objectOne.hitbox.bottom <= objectTwo.hitbox.bottom);
